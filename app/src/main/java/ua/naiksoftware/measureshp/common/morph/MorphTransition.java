package ua.naiksoftware.measureshp.common.morph;
...
public class MorphTransition extends ChangeBounds {
    ...
    public static void makeTransition(Activity activity, View container, int colorFrom, int colorTo, int radiusFrom, int radiusTo, String transitionName) {
        ...
        MorphTransition sharedEnter = new MorphTransition(colorFrom, colorTo, radiusFrom, radiusTo, true);
        sharedEnter.setPathMotion(arcMotion);
        sharedEnter.setInterpolator(easeInOut);

        MorphTransition sharedReturn = new MorphTransition(colorTo, colorFrom, radiusTo, radiusFrom,  false);
        sharedReturn.setPathMotion(arcMotion);
        sharedReturn.setInterpolator(easeInOut);

        if (container != null) {
            container.setTransitionName(transitionName);
    ...
    public Animator createAnimator(final ViewGroup sceneRoot, TransitionValues startValues, final TransitionValues endValues) {
        ...
        transition.playTogether(changeBounds, color, corners);
